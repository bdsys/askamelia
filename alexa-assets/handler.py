...
def on_launch(event):
    onlunch_MSG = "Hi, I can tell you about Amelia Kat. Me and her are close friends."
...
def howOldGeneral(birthdate_formatted):
    reprompt_MSG = "Do you want to hear Amelia Kat's age again?"
    card_TITLE = "You've asked about Amelia's age."
    ...
    if(years_old > 2):
        ...
        if(month_difference == 0):
            string_response = f"Amelia Kat is {years_old} years old exactly."
            # card_TEXT = "Amelia Kat is {years_old} years old exactly."
        else:
            string_response = f"Amelia Kat is {years_old} year and {month_difference} months old."

    elif(years_old == 0):
        string_response = f"Amelia Kat is {month_difference} months old."
...
def howManyMonths(birthdate_formatted):
    reprompt_MSG = "Do you want to hear Amelia Kat's age in months again?"
...
def howManyWeeks(birthdate_formatted):
    reprompt_MSG = "Do you want to hear Amelia Kat's age in weeks again?"
    ...
    years_old = today_date.year - birthdate_formatted.year
    month_difference = today_date.month - birthdate_formatted.month
    day_difference = today_date.month - birthdate_formatted.month
    ...
    string_response = f"Amelia Kat is {weeks_old} weeks old."
    card_TEXT = string_response
...
def assistance(event):
    assistance_MSG = "Try asking me about Amelia Kat."
    reprompt_MSG = "What do you want to know about Amelia Kat?"
...
def fallback_call(event):
    ...
    reprompt_MSG = "Do you want to know more about Amelia Kat?"
